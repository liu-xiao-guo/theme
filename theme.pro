...
UBUNTU_TRANSLATION_DOMAIN="theme.liu-xiao-guo"
...
aptest.commands = bash $$PWD/theme/tests/autopilot/run
aptest.depends  = sub-theme

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/theme/tests/unit
unittest.depends  = sub-theme
